...
public class ProductServiceImpl implements ProductService {
    ...
    private final com.example.SuperMarket.modules.inventory.repositories.ProductRepository productRepository;
    private final CategoryRepository categoryRepository;

    public ProductServiceImpl(com.example.SuperMarket.modules.inventory.repositories.ProductRepository productRepository, CategoryRepository categoryRepository){
    ...
    public ProductResponseDTO getProductById(Long id) {
        Product producto = productRepository.findByIdAndActivoTrue(id)
    ...
    public ProductResponseDTO getProductByCodigoBarras(String codigoBarras) {
        Product producto = productRepository.findByCodigoBarrasAndActivoTrue(codigoBarras)
    ...
    public List<ProductResponseDTO> getProductsByCategoriaId(Long categoriaId) {
        return productRepository.findByCategoriaIdAndActivoTrue(categoriaId).stream()
                .map(this::mapToResponseDTO)
                .collect(Collectors.toList());
    }
