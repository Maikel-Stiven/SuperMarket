...
public class CategoryServiceImpl implements CategoryService {
    ...
    public CategoryDTO createCategory(CategoryDTO categoryDTO) {
        // Corregido para usar directamente el método optimizado del repositorio
        ...
        Category categoriaGuardada = categoryRepository.save(categoria);
    ...
    public CategoryDTO updateCategory(Long id, CategoryDTO categoryDTO) {
        ...
        // Corregido el uso de la validación de nombres duplicados
