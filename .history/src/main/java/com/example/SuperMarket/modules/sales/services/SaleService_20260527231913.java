...
public class SaleService {
    ...
    public SaleService(SaleRepository saleRepository, ProductRepository productRepository, EmployeeRepository employeeRepository){
    ...
    public Sale registrarVenta(CreateSaleDTO dto){
        Employee empleado = employeeRepository.findById(dto.getEmpleadoId().toString())
