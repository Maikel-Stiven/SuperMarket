...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductResponseDTO createProduct(ProductRequestDTO request) {
        if (productRepository.existsByCodigoBarras(request.getCodigoBarras())){
            throw new RuntimeException("El código de barras " + request.getCodigoBarras() + " ya está registrado en el sistema");
        }
    ...
    private ProductResponseDTO mapToResponseDTO(Product producto){
        return ProductResponseDTO.builder()
                ...
                .categoryId(producto.getCategoria() != null ? producto.getCategoria().getId() : null)
                .categoryName(producto.getCategoria() != null ? producto.getCategoria().getNombre() : null)
                .build();
    }
}