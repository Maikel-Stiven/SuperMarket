...
public class EmployeeController {
    ...
    public ResponseEntity<List<EmployeeResponseDTO>> getEmployeesByRole(@RequestParam Role rol){
        return ResponseEntity.ok(employeeService.getEmployeesByRole(rol));   
    }

    @GetMapping("/filtro/fecha")
    public ResponseEntity<List<EmployeeResponseDTO>> getEmployeesByDateRange(
